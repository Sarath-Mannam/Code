...
public class ValidationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)throws IOException, ServletException {
		...
		if (mobile == null || mobile.equals("")) {
			mobile_err_msg = "Employee mobile number is required";
			flag = false;
		}else {
            if(!mobile.startsWith("91")){
                mobile_err_msg = "Employee mobile number should start with 91-";
                flag=false;        
             }else {
                flag=true;
              }
		...
		if (flag == true) {
			...
			out.println("<table>");
			out.println("<tr><th>EID</th><td><input type = 'text' name = 'eid' value = '" + eid + "'/></td><td><font color = 'red' size = '5'>"+ eid_err_msg + "</font></td></tr>");
					
			out.println("<tr><th>ENAME</th><td><input type = 'text' name = 'ename' value = '" + ename + "'/></td><td><font color = 'red' size = '5'>"+ ename_err_msg + "</font></td></tr>");
					
			out.println("<tr><th>EAGE</th><td><input type = 'text' name = 'eage' value = '" + eage + "'/></td><td><font color = 'red' size = '5'>"+ eage_err_msg + "</font></td></tr>");
					
			out.println("<tr><th>EMAIL</th><td><input type = 'text' name = 'email' value = '" + email + "'/></td><td><font color = 'red' size = '5'>"+ email_err_msg + "</font></td></tr>");
				
			out.println("<tr><th>MOBILE</th><td><input type = 'text' name = 'mobile' value = '" + mobile+ "'/> </td><td><font color = 'red' size = '5'>"+ mobile_err_msg + "</font></td></tr>");
